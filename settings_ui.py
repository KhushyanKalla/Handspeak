...
class SettingsUI(QWidget):
    def __init__(self, with_live_preview=True):
        super().__init__()
        self.setWindowTitle("Settings")
        self.setGeometry(100, 100, 900, 600)
        self.set_background()
        self.with_live_preview = with_live_preview
        self.initUI()
    ...
    def initUI(self):
        ...
        # Add Live Preview Box if with_live_preview is True
        if self.with_live_preview:
...
if __name__ == "__main__":
    ...
    window = SettingsUI(with_live_preview=True)
    window.show()
    sys.exit(app.exec_())
